...
export default function PhilosophySection() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-[#F8F7F5] text-[#243328] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none mix-blend-darken bg-[url('https://www.transparenttextures.com/patterns/dust.png')]" />
      ...
      <div className="container mx-auto px-[8px] md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[#243328]/10 pb-6 mb-8 gap-4">
          ...
          <span className="font-mono text-[10px] md:text-xs uppercase tracking-widest text-[#5D6B62] hidden md:block">
            The Natural Way
          </span>
        </div>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-3 md:mb-6">
                  ...
                  <span className="font-mono text-[10px] md:text-xs font-bold text-[#243328]/15 md:text-[#243328]/20 group-hover:text-[#4A7C59]/40 transition-colors">
                    0{i + 1}
                  </span>
                </div>
                ...
                <div className="mb-3 md:mb-5">
                  <span
                    className="
                      ...
                      font-mono text-[8px] md:text-[9px]
