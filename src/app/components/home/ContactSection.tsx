      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 animate-fade-up">
            {/* Main Primary Card */}
            <div className="bg-[#1A2118] text-[#F2F0EA] rounded-3xl md:rounded-[2.5rem] p-8 relative overflow-hidden shadow-2xl group flex-1">
              {/* Internal Decoration */}
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {/* Location Card */}
              <div className="bg-white/60 backdrop-blur-md border border-white/40 p-8 rounded-3xl md:rounded-[2.5rem] hover:bg-white transition-colors duration-300 flex flex-col justify-between min-h-[200px]">
                <div>
              ...
              <Link
                ...
                className="group bg-white/60 backdrop-blur-md border border-white/40 p-8 rounded-3xl md:rounded-[2.5rem] hover:bg-[#25D366] transition-colors duration-500 flex flex-col justify-between relative overflow-hidden min-h-[200px]"
              >
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl md:rounded-[3rem] p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(26,33,24,0.1)] border border-white relative h-full">
              <div className="mb-10">
