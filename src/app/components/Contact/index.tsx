...
const WhatsAppIcon = () => (
  <svg
    ...
    fill="currentColor"
    viewBox="0 0 24 24"
    className={styles.whatsappIconSvg}
  >
    ...
    <div className={styles.container}>
      ...
      <div className={styles.mainGrid}>
          ...
          <div className={styles.infoList}>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <a href="mailto:apeywon@gmail.com" className={styles.infoLink}>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <a href="tel:+919528295991" className={styles.infoLink}>
                  +919528295991
                </a>{" "}
                <br></br>
                <a href="tel:+23057814480" className={styles.infoLink}>
                  +23057814480
                </a>
              </div>
            </div>
        ...
        <div className={styles.formColumn}>
          <h2 className={styles.sectionTitle}>Get In Touch For Enquiries</h2>
          <p className={styles.infoText}>
