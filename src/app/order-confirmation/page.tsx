    ...
    return (
      <div className="min-h-screen bg-[#D9DBD5] flex items-center justify-center">
        <div className="text-center p-6">
          <h1 className="text-3xl font-bold text-[#1A2118] mb-4">
            Order Not Found
          </h1>
          <Link
            href="/"
            className="inline-flex items-center gap-2 h-14 px-8 bg-[#1A2118] text-white rounded-sm font-bold text-base uppercase tracking-widest hover:bg-[#BC5633] transition-colors shadow-lg"
          >
            Back Home
          </Link>
        </div>
        ...
        <div className="relative z-10 pt-16 lg:pt-32 pb-6 lg:pb-12 px-2 lg:px-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="text-center mb-8 animate-fade-up">
              <div className="w-20 h-20 md:w-24 md:h-24 bg-[#3A4D39] rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-[#3A4D39]/30 animate-scale-check">
                <Check className="w-10 h-10 text-white" strokeWidth={3} />
              </div>
              <h1 className="text-3xl md:text-6xl font-serif font-medium text-[#1A2118] mb-3 md:mb-4 tracking-tight">
                Order Confirmed!
              </h1>
              {/* Increased font size for mobile readability */}
              <p className="text-base md:text-xl text-[#596157] max-w-lg mx-auto leading-relaxed px-4">
            ...
            >
              {/* Header Bar */}
              <div className="bg-[#1A2118] text-[#F2F0EA] p-5 md:p-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
                <div>
                  <p className="text-sm font-bold uppercase tracking-widest opacity-60 mb-1">
                    Order Number
                  </p>
                  {/* Larger text for Order Number */}
                  <p className="text-xl md:text-2xl font-mono">{orderNumber}</p>
                </div>
              ...
              <div className="p-5 md:p-12">
                ...
                <div className="space-y-6 mb-8 md:mb-10">
                  ...
                  {order.items.map((item) => (
                    ...
                    >
                      <div className="w-16 h-16 bg-white rounded-sm overflow-hidden border border-[#1A2118]/5 shadow-sm flex-shrink-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h4 className="font-bold text-[#1A2118] text-base md:text-lg truncate">
                          {item.name}
                        </h4>
                ...
                {/* Totals - Increased Font Sizes */}
                <div className="space-y-3 text-base font-medium text-[#596157]">
                  ...
                  <div className="flex justify-between text-2xl md:text-3xl font-serif font-bold text-[#1A2118] pt-4 mt-4 border-t border-[#1A2118]/10">
                    <span>Total</span>
            ...
            >
              {/* What's Next */}
              <div className="bg-white/40 backdrop-blur-md border border-white/40 rounded-sm p-6 md:p-8">
                ...
                <div className="space-y-6 relative">
                  ...
                  <div className="flex gap-4 relative">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-[#1A2118]">
                        Order Confirmed
                      </p>
                      <p className="text-sm text-[#596157]">
                  ...
                  <div className="flex gap-4 relative">
                    ...
                    <div>
                      <p className="text-base font-bold text-[#1A2118]/60">
                        Processing
                      </p>
                      <p className="text-sm text-[#596157]">
                  ...
                  <div className="flex gap-4 relative">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#596157]">On its way to you.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Need Help? */}
              <div className="bg-[#1A2118] text-[#F2F0EA] rounded-sm p-6 md:p-8 flex flex-col justify-between gap-6">
                <div>
            ...
            {/* --- ACTION BUTTONS --- */}
            <div
              className="mt-8 md:mt-12 flex flex-col sm:flex-row justify-center gap-4 animate-fade-up"
              style={{ animationDelay: "0.5s" }}
            >
              <Link
                href="/shop"
                className="h-14 px-8 bg-[#1A2118] text-white rounded-sm font-bold text-base uppercase tracking-widest hover:bg-[#BC5633] transition-colors shadow-lg flex items-center justify-center gap-3"
              >
                <ShoppingBag className="w-5 h-5" /> Continue Shopping
              </Link>
              <Link
                href="/"
                className="h-14 px-8 bg-white border border-[#1A2118]/10 text-[#1A2118] rounded-sm font-bold text-base uppercase tracking-widest hover:bg-[#F2F0EA] transition-colors flex items-center justify-center gap-3"
              >
